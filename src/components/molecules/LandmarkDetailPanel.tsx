...
interface LandmarkDetailPanelProps {
  ...
  onClose: () => void;
  /** Straight-line distance from browser geolocation to the landmark, when available. */
    ...
    <div className="absolute bottom-0 left-0 right-0 z-[1000] md:bottom-auto md:top-0 md:right-0 md:left-auto md:w-96 md:h-full flex flex-col bg-white shadow-2xl border-t md:border-t-0 md:border-l border-gray-200 max-h-[65vh] md:max-h-full overflow-y-auto">
      ...
      <div className="p-4 flex-1">
        ...
        <div className="mt-4 pt-4 border-t border-gray-100">
          {distanceFromUserM != null && Number.isFinite(distanceFromUserM) ? (
            <p className="text-xs font-semibold text-[#002D5B]">
              About {formatDistanceMeters(distanceFromUserM)} from your location
            </p>
          ) : null}
          <p className={`text-xs text-gray-400 ${distanceFromUserM != null ? "mt-1.5" : ""}`}>
